        ...
        >
          <Card className="bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl border border-accent/20 shadow-2xl hover:shadow-accent/20 hover:border-accent/40 transition-all duration-300 group">
            <CardContent className="p-6 sm:p-8">
              <motion.h2 
                className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-center bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent group-hover:from-accent group-hover:to-accent/80 transition-all duration-300"
                whileInView={{ scale: [0.9, 1] }}
                transition={{ duration: 0.5 }}
              >
                The Problem We're Solving
              </motion.h2>
              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed text-center group-hover:text-gray-200 transition-colors duration-300">
